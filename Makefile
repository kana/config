...
PACKAGE_vim_grex_FILES=\
  ...
  vim/dot.vim/doc/grex.txt \
  vim/dot.vim/plugin/grex.vim
...
PACKAGE_vim_ku_source_buffer_FILES=\
  ...
  $(PACKAGE_vim_ku_source_buffer_FILES_core) \
  $(PACKAGE_vim_ku_source_buffer_FILES_kinds)
PACKAGE_vim_ku_source_buffer_FILES_actions=\
  vim/dot.vim/autoload/ku/action/buffer.vim
PACKAGE_vim_ku_source_buffer_FILES_core=\
  vim/dot.vim/autoload/ku/source/buffer.vim \
  vim/dot.vim/doc/ku-source-buffer.txt \
...
PACKAGE_vim_ku_source_file_FILES=\
  $(PACKAGE_vim_ku_source_file_FILES_actions) \
  $(PACKAGE_vim_ku_source_file_FILES_core) \
  $(PACKAGE_vim_ku_source_file_FILES_kinds)
PACKAGE_vim_ku_source_file_FILES_actions=\
  vim/dot.vim/autoload/ku/action/file.vim
PACKAGE_vim_ku_source_file_FILES_core=\
  vim/dot.vim/autoload/ku/source/file.vim \
  vim/dot.vim/doc/ku-source-file.txt \
  vim/dot.vim/plugin/ku/source/file.vim
PACKAGE_vim_ku_source_file_FILES_kinds=\
...
PACKAGE_vim_ku_source_quickfix_FILES=\
  $(PACKAGE_vim_ku_source_quickfix_FILES_core)
PACKAGE_vim_ku_source_quickfix_FILES_core=\
  vim/dot.vim/autoload/ku/source/quickfix.vim \
  vim/dot.vim/doc/ku-source-quickfix.txt \
  vim/dot.vim/plugin/ku/source/quickfix.vim

PACKAGE_vim_ku_source_source_ARCHIVE=vim-ku-source-source-0.2.0
PACKAGE_vim_ku_source_source_BASE=vim/dot.vim
PACKAGE_vim_ku_source_source_FILES=\
  $(PACKAGE_vim_ku_source_source_FILES_core)
PACKAGE_vim_ku_source_source_FILES_core=\
  vim/dot.vim/autoload/ku/source/source.vim \
  vim/dot.vim/doc/ku-source-source.txt \
  vim/dot.vim/plugin/ku/source/source.vim
...
PACKAGE_vim_misc_FILES=\
  ...
  vim/dot.vim/after/syntax/help/bugfix.vim \
...
# vim-grex  #{{{2
TESTS_vim_grex = basic

test/vim-grex/%.output: \
		test/vim-grex/%.input \
		test/libtest.vim \
		test/tester-vim \
		vim/dot.vim/autoload/grex.vim \
